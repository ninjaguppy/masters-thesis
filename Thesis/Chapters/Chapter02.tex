...
It is the opinion of the author that all of these topologies are definitely
broken. As shown above, the free topology lacks a wealth of compact sets.
Additionally, see that the fine topology (and therefore any admissible topology)
...
\ref{pt:two} seeks to solve some of these issues by extendend the definitions of
